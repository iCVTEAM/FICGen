...
def main(xml_folder, image_folder, output_folder, txt_file, batch_size):
    # 加载 YOLOv8 模型
    #model = YOLO('/cpfs/shared/public/wwz/best.pt')
    model = YOLO("/cpfs/user/wenzhuangwang/AeroGen-ori/best.pt")
    #----------------------------------delete
    # # 获取类别名称
...
xml_folder = "/cpfs/user/wenzhuangwang/FICGen/datasets/dior/annotations/HBB/"
image_folder = '/cpfs/user/wenzhuangwang/FICGen/generated_images/dior_sd15_new_up16_new/'
output_folder = './DIOR_OD/Yolov8_DIOR/pred'
txt_file = "/cpfs/user/wenzhuangwang/FICGen/datasets/dior/test.txt"
