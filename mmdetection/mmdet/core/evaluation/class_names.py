...
def coco_classes():
  ...
  #  return ["celestial object"]
    # return ['car', 'truck', 'trailer', 'bus', 'construction_vehicle', 'bicycle',
   #                 'motorcycle', 'pedestrian', 'traffic_cone', 'barrier']
   # return ["bicycle", "car", "motorbike", "bus", "bottle", "chair", "diningtable", "tvmonitor"]
 #   return ['person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle', 'bicycle']
 #   return ["vehicle", "baseballfield", "groundtrackfield", "windmill", "bridge", \
 ...
 #   return ["bridge", "airplane", "ground track field", "vehicle", "parking lot", "t junction", "baseball diamond", "tennis court", "basketball court", "ship", "crossroad", "harbor", "storage tank"]
...
#"crossroad", "harbor", "storage tank"]
  #  return ["bicycle", "boat", "bottle", "bus", "car", "cat", "chair", "cup","dog","motorbike", "people", "table"]
    return ['holothurian', 'echinus', 'scallop', 'starfish', 'fish', 'corals', 'diver', 'cuttlefish', 'turtle', 'jellyfish']
  #  return ["foreground"]
 #   return ["building"]
 #   return ["motorcycle", "person", "bus", "truck", "car"]
 #   return ['fish', 'reptiles', 'arthropoda', 'corals', 'mollusk', 'plants', 'ruins', 'garbage', 'human', 'robots']
 #   return [
 #       'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat',
 #       'chair', 'cow', 'diningtable', 'dog', 'horse', 'motorbike', 'person',
 #       'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor'
